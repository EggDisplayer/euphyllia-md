let handler = async (m, { conn, usedPrefix, command, args, isOwner, isAdmin, isROwner }) => {
  ...
  let okii = 'https://telegra.ph/file/844e39c35dcc297a03a84.jpg'
...
-Antibot | -Antifoto | -AntiSatir | -AntiSpam 
-AntiSticker | -AntiVirtex | -AutoPresence
-AutoReply | -AutoSticker | -AutoUpmine
-AutoJoin | -AutoLevelup | -BcJoin | -Detect
-Document | -WhiteListMyContact | -Restrict 
...
`.trim())
 ...
 conn.sendMessage(m.chat, { image: { url: okii }, caption: `╭───═[Status]
│⩽⩾ Tipe: *${type}*
│⩽⩾ Status: *Sukses!*
