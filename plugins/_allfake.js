...
handler.all = async function (m) {
	...
	try {
		...
		global.kontak2 = [
         [owner[0], await conn.getName(owner[0] + '6281398274790@s.whatsapp.net'), 'Dims', 'https://wa.me/6281398274790', true], // Kalo mau di tambah tinggal copy 1baris ini di tempel di bawahnya trs di edit dikit!
        ]
		...
		global.adReply = {
			contextInfo: {
				...
				externalAdReply: { // Bagian ini sesuka kalian berkreasi :'v
					...
					sourceUrl: "https://github.com/Im-Dims",					
				}
			}
		}
		global.fakeig = {
        ...
        global.fvn = {
            ...
            { remoteJid: "6281398274790-1625305606@g.us" } : {}) 
                       },
            message: { 
               "audioMessage": {
       ...
       key: {
                   fromMe: false,
                   participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "6281398274790@s.whatsapp.net" } : {})
               },
               message: {
                   "productMessage": {
                       "product": {
           ...
           "message": {
               "groupInviteMessage": {
                   "groupJid": "6281398274790-1625305606@g.us",
                   "inviteCode": "null",
